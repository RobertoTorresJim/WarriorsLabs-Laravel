					...
					<div class="table-container">
						<form method="POST" action="{{ route('user.store') }}"  role="form">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="ape_paterno" id="ape_paterno" class="form-control input-sm" placeholder="Apellido paterno">
									</div>
								</div>
                <div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="ape_materno" id="ape_materno" class="form-control input-sm" placeholder="Apellido materno">
									</div>
								</div>
                <div class="col-xs-6 col-sm-6 col-md-6">
                  <div class="form-group">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="delegacion" id="delegacion" class="form-control input-sm" placeholder="Delegación">
									</div>
								</div>
                <div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
